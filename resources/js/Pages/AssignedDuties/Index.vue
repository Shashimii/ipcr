...
const openDeleteModal = (assignedDuty) => {
    form.id = assignedDuty.id;
    form.officer = assignedDuty.officer.name;
    form.duty = assignedDuty.duty.name;
    form.odts_code = assignedDuty.odts_code;
    form.assigned_at = assignedDuty.assigned_at;
    form.is_done = assignedDuty.is_done;
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <tr v-for="duty in assignedDuties.data" :key="duty.id">
                                                <td
        ...
        <template #default>
            <div class="p-6 w-[30rem]">
                <div class="flex items-center justify-start space-x-4">
                    ...
                    <h2 class="text-lg font-semibold">Delete Assigned Duty ?</h2>
                </div>

                <p class="mt-4 text-md text-gray-600 text-justify">
                    Are you sure you want to delete
                    <strong>{{ form.duty }}</strong> assigned to
