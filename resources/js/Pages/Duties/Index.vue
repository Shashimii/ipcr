...
const openDeleteModal = (duties) => {
    form.id = duties.id;
    form.name = duties.name;
        ...
        <template #default>
            <div class="p-6 w-[30rem]">
                <div class="flex items-center justify-start space-x-4">
                    ...
                    <h2 class="text-lg font-semibold">Delete Duty ?</h2>
                </div>

                <p class="mt-4 text-md text-gray-600 text-left">
                    Are you sure you want to delete duty
                ...
                <div class="mt-6 flex justify-end gap-4">
                    ...
                    <form @submit.prevent="saveDelete">
                        <DangerButton :disabled="form.processing">Delete Duty</DangerButton>
                    </form>
                </div>
            </div>
        </template>
